...
namespace ChangeCalculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            GetChange(productPrice, payment);
        }

        public static void GetChange(double productPrice, double payment)
        {
        ...
        private static bool IsPaymentValid(double productPrice, double payment)
        {
